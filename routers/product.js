...
router.post('/', upload.any("imagen","reverse"), productController.store);         //4_ /products (POST) Accion de creacion, donde se envia el formulario
router.get('/edit/:id', productController.edit)                                   //5_ /products/:id/edit (GET) Formulario de edición de productos
router.put('/:id', upload.any("imagen","reverse"), productController.update)     //6_ /products/:id (PUT) Acción de edición (a donde se envía el formulario):
